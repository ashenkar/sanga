		...
		array(
			...
			"params" => array(
				...
				array(
					"type" => 'textfield',
					"heading" => __("Networks", "ultimate-social-deux"),
					"description" => __("Comma seperate a list of networks you would like to display. Available networks is:", "ultimate-social-deux") . ' ' . UltimateSocialDeux::buttons_string(),
					"param_name" => "networks",
				),
				array(
					"type" => 'checkbox',
