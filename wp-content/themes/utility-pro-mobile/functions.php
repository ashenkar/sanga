...
function utility_pro_setup() {
	...
	define( 'CHILD_THEME_NAME', 'utility-pro-mobile' );
	define( 'CHILD_THEME_URL', 'http://iskcon.us' );
...
function wps_lazyload_placeholder_image( $image ) {
    return 'http://iskcon.us/wp-content/uploads/2015/07/placeholder3.png';
}
